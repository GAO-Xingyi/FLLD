...
class FederatedCoordinator:
    ...
    def federated_learning(self):
        ...
        for epoch in range(self.num_epochs_update):
            ...
            fc1_weight_scores = {client_id: self.attention_scores[client_id]['fc1.weight'] for client_id in
                               self.attention_scores}
            ...
            logging.info(f'Attention Scores for fc1.weight: {fc1_weight_scores}')
